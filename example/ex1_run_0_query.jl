...
writedlm("result/ex1_0/networks_weights_with_name.txt", test)
println("==========networks weights from genemania==========")
print_dict(result_from_genemania)
println("======================================End================================")
println("Saving the result")
writedlm("result/ex1_0/cv_query.txt",model.cv_query)
writedlm("result/ex1_0/beta.txt",model.β)
writedlm("result/ex1_0/H.txt",model.H)
writedlm("result/ex1_0/networks_weights.txt",model.net_weights)
writedlm("result/ex1_0/networks_weights_each_cv.txt",model.weights_mat)
writedlm("result/ex1_0/singular_value_squared.txt",model.singular_value_squared)
