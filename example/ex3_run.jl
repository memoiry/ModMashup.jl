...
writedlm("result/ex3/networks_weights_with_name.txt", test)
println("======================================End================================")
println("Saving the result...Please wait")
#writedlm("result/ex3/cv_query.txt",model.cv_query)
#writedlm("result/ex3/beta.txt",model.β)
#writedlm("result/ex3/H.txt",model.H)
#writedlm("result/ex3/networks_weights.txt", tmp)
#writedlm("result/ex3/networks_weights_each_cv.txt",model.weights_mat)
#writedlm("result/ex3/singular_value_squared.txt",model.singular_value_squared)
